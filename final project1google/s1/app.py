...
def detect_phishing(subject, body):
    phishing_keywords = ['urgent', 'verify', 'account suspension', 'password reset', 'warning']
                ...
                for num in unread_message_nums:
                    ...
                    if status == "OK":
                        ...
                        if detect_phishing(subject, body):
                            ...
                            result_message = f"Warning: Phishing email detected from {sender} with subject: {subject} - IP Address: {ip_address}"
    ...
    <html lang="en">
      <head>
        ...
        <style>
            ...
            .fixed-bar input, .fixed-bar button {{
                margin-left: 10px;
            }}
            .fixed-bar a {{
                color: white;
